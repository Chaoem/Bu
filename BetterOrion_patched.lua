...
local function ApplyZIndex(obj, index)
    obj.ZIndex = index
    for _, child in ipairs(obj:GetChildren()) do
        ApplyZIndex(child, index)
    end
end
	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddParagraph(Text, Content, ImageAssetId, Buttons)
				...
				local function createButton(config)
					...
					local ButtonFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255)
        ApplyZIndex(ButtonFrame, 2), 0, 5), {
						Size = UDim2.new(1, 0, 0, 30),
						AutomaticSize = Enum.AutomaticSize.Y,
						Parent = Button
					}), {
        ...
        ApplyZIndex(ButtonFrame, 2), 0, 5), {
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				local ToggleFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255)
        ApplyZIndex(ToggleFrame, 2), 0, 5), {
			...
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				local DropdownFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255)
        ApplyZIndex(DropdownFrame, 2), 0, 5), {
					Size = UDim2.new(1, 0, 0, 38),
					Parent = ItemParent,
					ClipsDescendants = true
				}), {
			...
			function ElementFunction:AddMultiDropdown(MultiDropdownConfig)
				...
				local MultiDropdownFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255)
        ApplyZIndex(DropdownFrame, 2), 0, 5), {
					Size = UDim2.new(1, 0, 0, 38),
					Parent = ItemParent,
					ClipsDescendants = true
